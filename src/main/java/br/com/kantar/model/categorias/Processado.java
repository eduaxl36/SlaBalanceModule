...
List<Televisor>SintoniasTelevisor = new ArrayList(); 
    ...
    public Processado(List<Cabo> Cabo, List<Crianca> Crianca, List<Familia> Familia, List<Idade> Idade, List<Nse> Nse, List<Televisor> Televisor) {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 79 * hash + Objects.hashCode(this.SintoniasCabo);
        hash = 79 * hash + Objects.hashCode(this.SintoniasCrianca);
        hash = 79 * hash + Objects.hashCode(this.SintoniasFamilia);
        hash = 79 * hash + Objects.hashCode(this.SintoniasIdade);
        hash = 79 * hash + Objects.hashCode(this.SintoniasNse);
        hash = 79 * hash + Objects.hashCode(this.SintoniasTelevisor);
        return hash;
    }
    ...
    public String toString() {
        return "Processado{" + "SintoniasCabo=" + SintoniasCabo + ", SintoniasCrianca=" + SintoniasCrianca + ", SintoniasFamilia=" + SintoniasFamilia + ", SintoniasIdade=" + SintoniasIdade + ", SintoniasNse=" + SintoniasNse + ", SintoniasTelevisor=" + SintoniasTelevisor + '}';
    }
